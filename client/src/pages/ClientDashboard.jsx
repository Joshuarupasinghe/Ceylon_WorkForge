...
function Header({ searchQuery, setSearchQuery, notifications, showNotifications, setShowNotifications, markAsRead, unreadCount }) {
  return (
...
function Messages() {
  ...
  const messages = [
    { id: 1, sender: "them", text: "Hi there! I've just finished the initial mockups for your website redesign.", time: "10:15 AM" },
    { id: 2, sender: "them", text: "I've focused on improving the user flow and modernizing the look and feel.", time: "10:16 AM" },
    { id: 3, sender: "me", text: "That sounds great! I'm excited to see what you've come up with.", time: "10:20 AM" },
    { id: 4, sender: "them", text: "Hi, I've completed the design drafts. Can we schedule a call to discuss?", time: "10:30 AM" }
  ];
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`text-sm truncate ${
                      conversation.unread ? "font-medium text-gray-800 dark:text-white" : "text-gray-500 dark:text-gray-400"
                    }`}>
