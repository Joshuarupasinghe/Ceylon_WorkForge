...
import { ChevronRight, Calendar, DollarSign, Tag, CheckCircle, X } from "lucide-react";
...
export function Projects({ searchQuery }) {
  ...
  // Submit new job request to the API
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          required
                          className={`w-full px-3 py-2 rounded-md bg-gray-700 text-gray-100 border ${
                            formErrors.subcategory ? 'border-red-500' : 'border-gray-600'
                          } appearance-none`}
                        >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className={`w-full pl-10 pr-3 py-2 rounded-md bg-gray-700 text-gray-100 border ${
                          formErrors.budget ? 'border-red-500' : 'border-gray-600'
                        }`}
                      />
                      {formErrors.budget && (
